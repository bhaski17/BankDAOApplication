...
<body>
    ...
    <div class="container">
        ...
        <p>Welcome to VB Bank. Please fill the credentials to create your new bank account.</p>
        <form action="createAccount" method="post">
            <div class="inputbox">
                <input type="text" name="name" placeholder="Name" inputmode="text" pattern="[a-z]*" required>
                <i class="fa-solid fa-circle-user icon2"></i>
            </div>
            <div class="inputbox">
                <input type="tel" name="phone" placeholder="Phone" inputmode="numeric" pattern="[0-9]*" maxlength="10" required>
            ...
            <div class="inputbox">
                <input type="password" name="password" placeholder="Password" inputmode="numeric" pattern="[0-9]*" maxlength="8">
                <i class="fa-solid fa-lock icon2"></i>
            </div>
            <div class="inputbox">
                <input type="password" name="confirmpassword" placeholder="Confirm Password" inputmode="numeric" pattern="[0-9]*" maxlength="8">
                <i class="fa-solid fa-lock icon2"></i>
            </div>
            <button class="started" type="submit">Create Account</button>
            <p class="already-have-account">Already have an account? <a href="login.jsp" class="next">Login</a></p>
        </form>
    </div>
