...
<% if (user != null) { %>
    ...
    <main>
        <!-- Card Row for Welcome and Balance Cards -->
        <div class="card-row">
            ...
            <!-- Current Balance Card on the Right -->
            <div class="balance-card">
                <h2>Current Balance</h2>
                <p><i class="fa-solid fa-indian-rupee-sign"></i> <%= user.getBal() %></p>
            </div>
        </div>
<marquee>Welcome to My Bank..</marquee>
        <!-- Transactions Card -->
        <div class="transactions-card">
            ...
            <table>
                ...
                <%ArrayList<Transaction> passbooks=tdao.getTransaction(user.getAcc_no()); %>
               <% for(Transaction t:passbooks){ %>
                <tbody>
