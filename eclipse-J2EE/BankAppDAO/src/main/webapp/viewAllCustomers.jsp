        ...
        <div class="transactions-card">
            ...
            <table>
                ...
                <tbody>
                    ...
                    int end = Math.min(start + rowsPerPage, customers.size());
                    ...
                    %>
                        <tr>
                            ...
                            <td><i class="fa-solid fa-indian-rupee-sign"></i><%= c.getBal() %></td>
                        </tr>
                    <% } %>
                </tbody>
            </table>
            ...
            <div class="pagination">
                <% 
                int totalPages = (int) Math.ceil((double) customers.size() / rowsPerPage);
                if (pageNumber > 1) { 
                %>
